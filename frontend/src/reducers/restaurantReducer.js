import {ALL_RESTAURANTS_SUCCESS, ALL_RESTAURANTS_FAIL, ALL_RESTAURANTS_REQUEST, CLEAR_ERRORS, TOGGLE_VEG_ONLY, SORT_BY_RATINGS, SORT_BY_REVIEWS} from "../constants/restaurantConstant.js";
...
export const restaurantReducer = (state=initialState, action) => {
    switch(action.type){
        case ALL_RESTAURANTS_REQUEST:
            return {
                ...state, // create a new object with the all current properties
                loading: true,
                error: null
            };
