  ...
  return (
    <>
      ...
      <div className="row d-flex justify-content-between">
          <div className="col-12 col-lg-8 mt-5 order-confirm cartt shadow-lg">
              <h4 className="mb-3">Delivery Info</h4>
              <p><b>Name : </b>{user && user.name}</p>
              <p><b>Phone Number : </b>{deliveryInfo.phoneNo}</p>
              <p className="mb-4">
                  <b>Address : </b>
                  ...
                  cartItems.map((item) => (
                    <Fragment key={item.id}>
                        ...
                        <div className="cart-item my-1" key={item.fooditem}>
                            <div className="row" id="add-scroll-bar">
                                <div className="col-4 col-lg-2">
                                    <img src={item.image} alt="item" height="45" width="65" className="img-border-round"/>
                                </div>
                                <div className="col-5 col-lg-4 col-sm-5">{item.name}</div>
                                <div className="col-8 col-lg-6 col-sm-5 mt-4 mt-lg-0">
                                    <p>
